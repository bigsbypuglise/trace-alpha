...
Write-Output ""
Write-Output "The nine transport controls to look for, in reading order:"
Write-Output "  Rewind, Play, Fast-forward, Mute, Volume, Loop, Timeline,"
...
Write-Output " Volume joined 2026-08-20 with the inline slider; under"
Write-Output " TRACE_VOLUME_SLIDER=0 it is absent and eight is correct. Its rect"
Write-Output " is EMPTY while the slider is collapsed -- the honest geometry for"
Write-Output " a control that is not on screen -- so an empty Volume rect in a"
Write-Output " walk taken without hovering Mute is expected, not a defect.)"
