...
Write-Output ""
Write-Output "The ten transport controls to look for, in reading order:"
Write-Output "  Go to Start, Rewind, Play, Fast-forward, Go to End, Mute, Loop,"
Write-Output "  Timeline, Toggle Fullscreen, Share."
Write-Output "(Five until UI redesign roadmap step 5; the five it added are"
Write-Output " interleaved into the left-to-right order, not appended.)"
